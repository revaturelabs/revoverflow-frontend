...
export const ProfileQuestionComponent: React.FC<ForumQuestionComponentProps> = (props) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileQuestionComponent);