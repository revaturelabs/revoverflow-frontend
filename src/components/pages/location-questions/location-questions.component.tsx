...
import { LocationFilterDropDown } from '../../common/location-filter-drop-down.component';
...
export const LocationQuestions: React.FC<FeedContainerComponentProps> = (props) => {
        ...
        <div>
            ...
            <Container className={classes.containerInternal}>
                <ThemeProvider theme={theme} >
                    <Box>
                        <LocationFilterDropDown location={(e:string) => handleLocationChange(e)} />
                    </Box>
                    <div style={{ width: '100%' }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(LocationQuestions);